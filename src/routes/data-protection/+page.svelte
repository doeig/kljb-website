<script>
	...
	const listing = [
		...
		"verwendetes BetriebssystemReferrer URL",
...
<section class="bg-white dark:bg-gray-900">
	<div class="py-8 px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-6">
		<Heading tag="h1" class="mb-8">Datenschutzerklärung</Heading>
		<Heading tag="h3" class="mb-4">Datenschutz</Heading>
		<P class="mb-3">
		...
		<Heading tag="h3" class="mb-4">Server-Log-Files</Heading>
		<P class="mb-3">
			Der Provider der Seiten erhebt und speichert automatisch Informationen in so genannten
			Server-Log Files, die Ihr Browser automatisch an uns übermittelt. Dies sind:
		</P>
		<List class="mb-3 space-y-1 text-gray-900 dark:text-white">
			<Li>Test</Li>
		...
		<Heading tag="h3" class="mb-4">Facebook-Plugins (Like-Button)</Heading>
		<P class="mb-3">
			...
			</A>. Wenn Sie unsere Seiten besuchen, wird über das Plugin eine direkte Verbindung zwischen
			...
			<A href="https://de-de.facebook.com/policy.php">https://de-de.facebook.com/policy.php</A>.
		...
		<Heading tag="h3" class="mb-4">Recht auf Auskunft, Löschung, Sperrung</Heading>
		<P class="mb-3">
			...
			Impressum angegebenen Adresse anuns wenden.
		</P>
		<P>Quelle: <A>https://www.e-recht24.de</A></P>
	</div>
</section>
